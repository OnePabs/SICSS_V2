...
public class TechDConstant extends ParentScript{
	...
	public TechDConstant(Long interArrivalTime, Long serviceTime, Long[] runTimes, int runTimeConversionFactorToMillis,
	...
	public void run() {
		...
		String resultsDirectory = resultsFolderPath 
				+ "/Tech-D-const-iat-"+String.valueOf(interArrivalTime) 
		...
		try {
			...
			if(isVerbose) {
				System.out.println("Technique D constant: could not complete experiment");
			}
			e.printStackTrace();
		}
		*/
